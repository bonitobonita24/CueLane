...
<!-- AIEF:MANAGED START -->
<!-- Auto-generated by scripts/sync-context.sh — do not edit between markers. Everything else is human-owned. Source rev: 0eff09b -->
...
**Last done:** RBAC view-access Wave 1 — matrix-driven enforcement (matrixProcedure + nav filter + per-page guards); commit ae8b333, cache-off typecheck/lint green, RBAC tests green (2026-08-09).
...
**Git branch:** feat/rbac-view-access (off feat/tenant-rbac-3tier). Wave 0 PUSHED to origin last session; Wave 1 commit ae8b333 LOCAL only — HARD HOLD, no push/deploy without owner word. main untouched.
