...
<!-- AIEF:MANAGED START -->
<!-- Auto-generated by scripts/sync-context.sh — do not edit between markers. Everything else is human-owned. Source rev: b8fb256 -->
...
**Git branch:** main (Phase 5 fixes committed local; UNPUSHED — HARD HOLD, local dev only)
