...
Dependent files reviewed (propagation checklist — the machine-readable Cross-Alignment map):
  [x] Prompt_References.md         — Prompt 3.24 added (Scenario Group 3)
  [x] Prompt_References.html       — matching 3.24 card + hero-stat prompt count 61→62
  [x] public/Prompt_References.html — mirrored 1:1 with the .md/.html above
  [x] scenarios.md                 — Scenario 41 added
  [x] phases.md                    — Phase 2.8 + Phase 3 pre-lock MODEL HOOK (panel gate) added
  [x] CLAUDE_compact.md            — version marker bumped; V32.24 changelog segment appended; prompt count 61→62
  [x] Framework_Feature_Index.md   — V32.24 row + footer version + counts
  [x] CLAUDE.md (project)          — canonical-counts block: 61→62 Prompts (38→39 NEW ✨), 40→41 Scenarios
  [x] public/documentation-hub.html — sd-counts callout + hero-sub bumped
  Canonical counts:                Prompts 61→62 (39 NEW ✨) · Scenarios 40→41 · all others UNCHANGED
                                    (33 Rules · 135 Checklist/20 · 28 deliverables · 18 hooks)
Ratified: 2026-07-05
═══════════════════════════════════════════════════════════════════════════════════ -->
